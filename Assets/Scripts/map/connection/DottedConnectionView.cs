...
public class DottedConnectionView : MonoBehaviour
{
    ...
    private RectTransform container; // assign self
    ...
    public void Initialize(RectTransform from, RectTransform to)
    {
        ...
        // Use centers, converted into parent's local space
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            // Ensure dot anchors don't sabotage anchoredPosition
